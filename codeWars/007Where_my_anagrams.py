...
print(anagrams1('abba', ['aabb', 'abcd', 'bbaa', 'dada'])," => ['aabb', 'bbaa']")
print(anagrams1('racer', ['crazer', 'carer', 'racar', 'caers', 'racer'])," => ['carer', 'racer']")
print(anagrams1('laser', ['lazing', 'lazy',  'lacer'])," => []")


print(anagrams2('abba', ['aabb', 'abcd', 'bbaa', 'dada'])," => ['aabb', 'bbaa']")
print(anagrams2('racer', ['crazer', 'carer', 'racar', 'caers', 'racer'])," => ['carer', 'racer']")
print(anagrams2('laser', ['lazing', 'lazy',  'lacer'])," => []")


print(anagrams3('abba', ['aabb', 'abcd', 'bbaa', 'dada'])," => ['aabb', 'bbaa']")
print(anagrams3('racer', ['crazer', 'carer', 'racar', 'caers', 'racer'])," => ['carer', 'racer']")
print(anagrams3('laser', ['lazing', 'lazy',  'lacer'])," => []")
